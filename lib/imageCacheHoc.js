...
export default function imageCacheHoc(Image, options = {}) {
  ...
  return class extends React.PureComponent {
     ...
     */
    static async cacheFile(url, permanent = false, cachePruneTriggerLimit, fileDirName) {

      const fileSystem = FileSystemFactory(cachePruneTriggerLimit || 1024 * 1024 * 15, fileDirName);
